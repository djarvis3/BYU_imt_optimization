...
/**
 * <p>Java class for edge-shape-content complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="edge-shape-content">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence>
 *         &lt;element ref="{http://www.gexf.net/1.2draft/viz}spells" minOccurs="0"/>
 *       &lt;/sequence>
 *       &lt;attribute name="value" use="required" type="{http://www.gexf.net/1.2draft/viz}edge-shape-type" />
...
@XmlType(name = "edge-shape-content", propOrder = {
    "spells"
})
public class EdgeShapeContent {

    private XMLSpellsContent spells;
    @XmlAttribute(required = true)
    private EdgeShapeType value;
    @XmlAttribute
     ...
     *     
     */
    public void setValue(EdgeShapeType value) {
        this.value = value;
    }
