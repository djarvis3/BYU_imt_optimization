package byu.imt.demand_Generation;
...
public class RunZPopulationGenerator {
    ...
    public static void main(String args[]) {
         ...
         */
        Scenario scenario = createPopulationFromCensusFile("./scenarios/zurich/input/input_sample_zurich.txt");

        /*
         * Write population to file.
         */
        PopulationWriter populationWriter =  new PopulationWriter(scenario.getPopulation(), scenario.getNetwork());
        populationWriter.write("./scenarios/zurich/input/population.xml");
