 ...
 * Two examples are provided here: A rule based and an assignment based dispatch algorithm.
 */
...
public class RunTaxi {
    ...
    public static void main(String[] args) {
       ...
       run(CONFIG_FILE_ASSIGNMENT, false, 20); // switch to 'true' to turn on visualisation
    }
}
