...
public class LinkEnterEvent_WithMode extends Event implements HasLinkId {
	...
	public LinkEnterEvent_WithMode(final double time, final Id<Vehicle> vehicleId, final Id<Link> linkId) {
		super(time);
		this.linkId = linkId;
		if ( vehicleId==null ) {
	...
	public Id<Person> getDriverId() {
		throw new RuntimeException( LinkLeaveEvent_WithMode.missingDriverIdMessage ) ;
	}	
	@Override
