...
public class LinkLeaveEvent_WithMode extends Event implements HasLinkId {
	...
	public LinkLeaveEvent_WithMode(final double time, final Id<Vehicle> vehicleId, final Id<Link> linkId) {
		super(time);
		this.linkId = linkId;
		if ( vehicleId==null ) {
			throw new RuntimeException( LinkEnterEvent_WithMode.missingVehicleIdMessage ) ;
		}
