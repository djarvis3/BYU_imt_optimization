...
public class PersonArrivalEvent_WithMode extends Event implements HasPersonId {
	...
	public PersonArrivalEvent_WithMode(final double time, final Id<Person> agentId, final Id<Link> linkId, final String legMode) {
		super(time);
		this.linkId = linkId;
