...
public class PersonDepartureEvent_WithMode extends Event implements HasPersonId {
	...
	public PersonDepartureEvent_WithMode(final double time, final Id<Person> agentId, final Id<Link> linkId, final String legMode, final String routingMode) {
		super(time);
		this.linkId = linkId;
