...
public class RunPPopulationGenerator implements Runnable {
    ...
    private CoordinateTransformation ct = TransformationFactory.getCoordinateTransformation(TransformationFactory.NAD83_UTM17N, TransformationFactory.NAD83_UTM17N);
    ...
    public void run() {
        ...
        populationWriter.write("C:/Users/Daniel Jarvis/BYU_imt_optimization/scenarios/cleveland/population.xml");
    }
    ...
    private Activity createWork(Coord workLocation) {
        ...
        activity.setEndTime(17*60*60); //work activity time = 5pm
        return activity;
    }

    private Activity createHome(Coord homeLocation) {
        Activity activity = population.getFactory().createActivityFromCoord("home", homeLocation);
        activity.setEndTime(9*60*60); //home activity time = 9am
        return activity;
    }
