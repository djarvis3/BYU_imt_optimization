...
public class MyPerson {
    ...
    private Plan createPlans(Random r){
        ...
        // if dap is school, then go to school and maybe go to work
            ...
            Integer schoolEndTime = r.nextInt(3*60*60) + 14*60*60; //generate random school time between 2:00pm and 5:00pm
        ...
        // if dap is non mandatory then go to 1-3 places
            ...
            Integer newHomeStart = r.nextInt(3*60*60)+15*60*60; //generate random times for home activities to end between 3pm and 6pm
