...
public class IncidentPlansReader {
    ...
    public void parseCrashData(String csv) {
        ...
        while ((record = parser.parseNextRecord()) != null) {
            ...
            // get accident coordinates from csv file
            if (record.getString("Location") != null) { // there is an accident at this location
               Double x = record.getDouble("Longitude");
               Double y = record.getDouble("Latitude");
               Coord accidentCord = CoordUtils.createCoord(x, y);
               accidentCord = ct.transform(accidentCord);
